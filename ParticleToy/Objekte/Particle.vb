...
Public Class Particle
    ...
    Public Sub Update(Game As GameBase, Tick As Integer, MouseInfo As MouseInfo, Keyboard As Microsoft.VisualBasic.Devices.Keyboard, Behaviour As IBehaviour, NotBehaviours As IBehaviour())
        'Normalisierung
        '#######################################################################################
        Lightnight = Nothing
        For Each NotBeaviour As IBehaviour In NotBehaviours
            NotBeaviour.NormalizeNot(Me, Game, Tick, MouseInfo, Keyboard)
        Next
